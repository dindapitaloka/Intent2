...
public class InputActivity extends AppCompatActivity {
    ...
    findViewById(R.id.buttonFinish).setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v)
        {
           ...
           EditText etThnLhr = (EditText)  findViewById(R.id.editTextThnLahir);
           String nama = etNama.getText().toString();
           String ThnLahirStr = etThnLhr.getText().toString();

           int ThnLahir = ThnLahirStr.isEmpty()?
                   Calendar.getInstance().get(Calendar.YEAR):
                   Integer.parseInt(ThnLahirStr);
            Intent intent = new Intent();
            intent.putExtra(NAMA, nama);
            intent.putExtra(TAHUN_LAHIR,ThnLahir);
